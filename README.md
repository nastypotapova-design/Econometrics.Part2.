...
|----------|-------------|------------|---------|
| Intercept | -1.7459 | 0.174 | 0.0000*** |
| Age | 0.0027 | 1.003 | 0.1775 |
| Sex (female=1) | -0.1274 | 0.880 | 0.0002*** |
| Education | 0.0131 | 1.013 | 0.5980 |
| Marital Status | -0.0814 | 0.922 | 0.0232* |
| Avg Payment Delay | 1.3871 | 4.003 | 0.0000*** |
| Avg Debt-to-Limit | 0.2439 | 1.276 | 0.0000*** |
