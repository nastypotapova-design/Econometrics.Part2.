...
with open('README', 'w', encoding='utf-8') as f:
    ...
    f.write('|----------|-------------|------------|---------|\n')
    f.write(f'| Intercept | {params["const"]:.4f} | {odds_ratios["const"]:.3f} | {p_values["const"]:.4e} |\n')
    f.write(f'| Age | {params["age"]:.4f} | {odds_ratios["age"]:.3f} | {p_values["age"]:.4f} |\n')
    f.write(f'| Sex (female=1) | {params["sex"]:.4f} | {odds_ratios["sex"]:.3f} | {p_values["sex"]:.4e} |\n')
    f.write(f'| Education | {params["edu"]:.4f} | {odds_ratios["edu"]:.3f} | {p_values["edu"]:.4f} |\n')
    f.write(f'| Marital Status | {params["mar"]:.4f} | {odds_ratios["mar"]:.3f} | {p_values["mar"]:.4e} |\n')
    f.write(
        f'| Avg Payment Delay | {params["avg_delay"]:.4f} | {odds_ratios["avg_delay"]:.3f} | {p_values["avg_delay"]:.4e} |\n')
    f.write(
        f'| Avg Debt-to-Limit | {params["avg_debt_to_limit"]:.4f} | {odds_ratios["avg_debt_to_limit"]:.3f} | {p_values["avg_debt_to_limit"]:.4e} |\n\n')
